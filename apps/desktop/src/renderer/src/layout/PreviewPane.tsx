      ...
      <div className="preview-header">
        ...
        <div className="preview-header__actions">
          {isDetached ? (
            ...
            <>
              {isRunning
                ? <button type="button" className="preview-action-btn" onClick={handleRefresh}>↺ Refresh</button>
                : <button type="button" className="preview-action-btn preview-action-btn--start"
                    onClick={handleStart} disabled={!project}>▶ Start</button>
              }
              <button type="button" className="preview-action-btn" onClick={handleDetach}>↗ Detach</button>
            </>
          )}
